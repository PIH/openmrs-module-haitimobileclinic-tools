...
INSERT INTO `scheduler_task_config` VALUES (1,'Update Concept Index','Iterates through the concept dictionary, re-creating the concept index (which are used for searcing). This task is started when using the \'Update Concept Index Storage\' page and no range is given.  This task stops itself when one iteration has completed.','org.openmrs.scheduler.tasks.ConceptIndexUpdateTask',NULL,NULL,0,0,0,1,'2005-01-01 00:00:00',2,'2013-02-12 23:13:35',NULL,'7c75911e-0310-11e0-8222-18a905e044dc'),(2,'Auto Close Visits Task','Stops all active visits that match the visit type(s) specified by the value of the global property \'visits.autoCloseVisitType\'','org.openmrs.scheduler.tasks.AutoCloseVisitsTask','2011-11-28 23:59:59','MM/dd/yyyy HH:mm:ss',86400,0,0,1,'2013-02-05 08:48:28',NULL,NULL,NULL,'8c17b376-1a2b-11e1-a51a-00248140a5eb'),(3,'Initialize Logic Rule Providers',NULL,'org.openmrs.logic.task.InitializeLogicRuleProvidersTask','2013-03-04 12:47:38',NULL,1999999999,0,1,2,'2013-02-05 08:49:00',2,'2013-03-04 12:47:42','2013-03-04 12:47:41','c0dd698c-1850-469a-8c2f-c3816ccd27e4'),(46,'Process Usage Statistics Data','Deletes or aggregates old usage statistics data','org.openmrs.module.usagestatistics.tasks.AggregatorTask','2013-03-04 00:00:00',NULL,3600,1,1,2,'2013-03-04 11:54:50',2,'2013-03-04 13:00:00','2013-03-04 13:00:00','324c17f4-46a5-4e58-890e-3a2d0c716b91'),(47,'Send Usage Statistics Reports','Sends usage statistics reports','org.openmrs.module.usagestatistics.tasks.SendReportsTask','2013-03-04 00:00:00',NULL,86400,1,1,2,'2013-03-04 11:54:50',NULL,NULL,NULL,'2bbb517c-3d97-4330-b1c9-2ce808339b29');
